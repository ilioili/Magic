...
public class Pyramids3Game extends Activity{
	private int time;
	private TextView tv;
	public Pyramids3View pv;
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    pv=(Pyramids3View)findViewById(R.id.pyramidView1);
	    tv=(TextView)findViewById(R.id.pyramidTime);
