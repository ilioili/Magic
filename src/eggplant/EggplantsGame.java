...
public class EggplantsGame extends Activity{
	private int time;
	private TextView tv;
	public EggplantsView ev;
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    ev=(EggplantsView)findViewById(R.id.eggplants);
	    tv=(TextView)findViewById(R.id.eggplantTime);
